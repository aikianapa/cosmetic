                    ...
                    <div class="product_header">
                        ...
                        <div class="product_tab_btn">
                            <ul class="nav" role="tablist">
                                <li>
                                    <a class="active" data-toggle="tab" href="{{_var.base}}/makeup" role="tab" aria-controls="makeup" aria-selected="true"> 
                                       Makeup
                                    </a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="{{_var.base}}/skin" role="tab" aria-controls="skin" aria-selected="false">
                                        Skin Care
                                    </a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="{{_var.base}}/health" role="tab" aria-controls="health" aria-selected="false">
                                        Health Care
                                    </a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="{{_var.base}}/nailart" role="tab" aria-controls="nailart" aria-selected="false">
                                        Nail Art & Tools
                                    </a>
                                </li>
                            </ul>
                                            ...
                                            <div class="product_gallery_left">
                                                <div class="product_carousel product_column1 owl-carousel">
                                                    <article class="single_product">
                                                        <figure>
                                                            <div class="product_thumb">
                                                                <a class="primary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/productbig1.jpg" alt=""></a>
                                                                <a class="secondary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/productbig2.jpg" alt=""></a>
                                                                <div class="label_product">
                                                                    <span class="label_sale">-15%</span>
                                                                </div>
                                                                <div class="action_links">
                                                    ...
                                                    <article class="single_product">
                                                        <figure>
                                                            <div class="product_thumb">
                                                                <a class="primary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/productbig3.jpg" alt=""></a>
                                                                <a class="secondary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/productbig4.jpg" alt=""></a>
                                                                <div class="label_product">
                                                                    <span class="label_sale">-15%</span>
                                                                </div>
                                                                <div class="action_links">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="product_items top">
                                                            <article class="single_product">
                                                                <figure>
                                                                    <div class="product_thumb">
                                                                        <a class="primary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/product6.jpg" alt=""></a>
                                                                        <a class="secondary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/product7.jpg" alt=""></a>
                                                                        <div class="label_product">
                                                                            <span class="label_sale">-15%</span>
                                                                        </div>
                                                                        <div class="action_links">
                                                                    ...
                                                                    <figcaption class="product_content">
                                                                        <h4 class="product_name"><a href="{{_var.base}}/product-details.html">Originals Kaval Windbreaker</a></h4>
                                                                        <div class="price_box">
                                                            ...
                                                            <article class="single_product">
                                                                <figure>
                                                                    <div class="product_thumb">
                                                                        <a class="primary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/product8.jpg" alt=""></a>
                                                                        <a class="secondary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/product9.jpg" alt=""></a>
                                                                        <div class="label_product">
                                                                            <span class="label_sale">-15%</span>
                                                                        </div>
                                                                        <div class="action_links">
                                                                    ...
                                                                    <figcaption class="product_content">
                                                                        <h4 class="product_name"><a href="{{_var.base}}/product-details.html">Juicy Couture Juicy Quilted</a></h4>
                                                                        <div class="price_box">
                                                                            <span class="old_price">$180.00</span>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="product_items">
                                                            <article class="single_product">
                                                                <figure>
                                                                    <div class="product_thumb">
                                                                        <a class="primary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/product11.jpg" alt=""></a>
                                                                        <a class="secondary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/product10.jpg" alt=""></a>
                                                                        <div class="label_product">
                                                                            <span class="label_sale">-15%</span>
                                                                        </div>
                                                                        <div class="action_links">
                                                                    ...
                                                                    <figcaption class="product_content">
                                                                        <h4 class="product_name"><a href="{{_var.base}}/product-details.html">Water and Wind Resistant</a></h4>
                                                                        <div class="price_box">
                                                            ...
                                                            <article class="single_product">
                                                                <figure>
                                                                    <div class="product_thumb">
                                                                        <a class="primary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/product9.jpg" alt=""></a>
                                                                        <a class="secondary_img" href="{{_var.base}}/product-details.html"><img data-src="{{_var.base}}/assets/img/product/product7.jpg" alt=""></a>
                                                                        <div class="label_product">
                                                                            <span class="label_sale">-15%</span>
                                                                        </div>
                                                                    ...
                                                                    <figcaption class="product_content">
                                                                        <h4 class="product_name"><a href="{{_var.base}}/product-details.html">New Balance Fresh Foam</a></h4>
                                                                        <div class="price_box">
